...
public class activity_pdf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            fields.get("vieta").setValue(data1.get("FP_Accident_Location")).setFontSize(10).setBorderWidth(0f);
            ...
            if(data1.get("FP_other_than_A_B").equals("true") || data2.get("SP_other_than_A_B").equals("true")){
                fields.get("zala_turtui_2").setValue("Yes");
            }
            else {
                fields.get("zala_turtui_1").setValue("Yes");
            }


            if(data1.get("FP_other_than_A_B_vehicles").equals("true") || data2.get("SP_other_than_A_B_vehicles").equals("true")){
                fields.get("zala_turtui_4").setValue("Yes");
            }
            else{
                fields.get("zala_turtui_3").setValue("Yes");
            }


            fields.get("liudininkai").setValue(data1.get("FP_Witness")).setFontSize(10).setBorderWidth(0f);
            ...
            fields.get("A_tp_variklis_numerio_zenklas").setValue(data1.get("FP_CarNumber")).setFontSize(12).setBorderWidth(0f);
            ...
            if(data1.get("FP_DoesCover").equals("true")){
                fields.get("A_draudimas_ar_atlygintina_taip").setValue("Yes");
            }
            else{
                fields.get("A_draudimas_ar_atlygintina_ne").setValue("Yes");
            }
            ...
            fields.get("A_vairuotojas_pazymejimas_galioja_iki").setValue(data1.get("FP_License_valid_until")).setFontSize(8).setBorderWidth(0f);


            //A matomi sugadinimai
            fields.get("A_sugadinimai").setValue(data1.get("FP_Remarks_damage")).setFontSize(10).setBorderWidth(0f);
            fields.get("A_pastabos").setValue(data1.get("FP_Remarks")).setFontSize(10).setBorderWidth(0f);


            //A CHECKBOXES
            if(data1.get("FP_1").equals("true")){
                fields.get("A_12_1").setValue("Yes");
            }
            if(data1.get("FP_2").equals("true")){
                fields.get("A_12_2").setValue("Yes");
            }
            if(data1.get("FP_3").equals("true")){
                fields.get("A_12_3").setValue("Yes");
            }
            if(data1.get("FP_4").equals("true")){
                fields.get("A_12_4").setValue("Yes");
            }
            if(data1.get("FP_5").equals("true")){
                fields.get("A_12_5").setValue("Yes");
            }
            if(data1.get("FP_6").equals("true")){
                fields.get("A_12_6").setValue("Yes");
            }
            if(data1.get("FP_7").equals("true")){
                fields.get("A_12_7").setValue("Yes");
            }
            if(data1.get("FP_8").equals("true")){
                fields.get("A_12_8").setValue("Yes");
            }
            if(data1.get("FP_9").equals("true")){
                fields.get("A_12_9").setValue("Yes");
            }
            if(data1.get("FP_10").equals("true")){
                fields.get("A_12_10").setValue("Yes");
            }
            if(data1.get("FP_11").equals("true")){
                fields.get("A_12_11").setValue("Yes");
            }
            if(data1.get("FP_12").equals("true")){
                fields.get("A_12_12").setValue("Yes");
            }
            if(data1.get("FP_13").equals("true")){
                fields.get("A_12_13").setValue("Yes");
            }
            if(data1.get("FP_14").equals("true")){
                fields.get("A_12_14").setValue("Yes");
            }
            if(data1.get("FP_15").equals("true")){
                fields.get("A_12_15").setValue("Yes");
            }
            if(data1.get("FP_16").equals("true")){
                fields.get("A_12_16").setValue("Yes");
            }
            if(data1.get("FP_17").equals("true")){
                fields.get("A_12_17").setValue("Yes");
            }
            fields.get("count_A").setValue(data1.get("FP_CircumstancesC")).setFontSize(12).setBorderWidth(0f);
            ...
            fields.get("B_tp_variklis_numerio_zenklas").setValue(data2.get("SP_CarNumber").toString()).setFontSize(12).setBorderWidth(0f);
            ...
            if(data2.get("SP_DoesCover").toString().equals("true")){
                fields.get("B_draudimas_ar_atlygintina_taip").setValue("Yes");
            }
            else{
                fields.get("B_draudimas_ar_atlygintina_ne").setValue("Yes");
            }


            //B vairuotojas
            fields.get("B_vairuotojas_pavarde").setValue(data2.get("SP_LastName").toString()).setFontSize(12).setBorderWidth(0f);
            ...
            fields.get("B_vairuotojas_pazymejimas_galioja_iki").setValue(data2.get("SP_License_valid_until").toString()).setFontSize(8).setBorderWidth(0f);


            //B Checkboxes
            if(data2.get("SP_1").toString().equals("true")){
                fields.get("B_12_1").setValue("Yes");
            }
            if(data2.get("SP_2").toString().equals("true")){
                fields.get("B_12_2").setValue("Yes");
            }
            if(data2.get("SP_3").toString().equals("true")){
                fields.get("B_12_3").setValue("Yes");
            }
            if(data2.get("SP_4").toString().equals("true")){
                fields.get("B_12_5").setValue("Yes");
            }
            if(data2.get("SP_6").toString().equals("true")){
                fields.get("B_12_6").setValue("Yes");
            }
            if(data2.get("SP_7").toString().equals("true")){
                fields.get("B_12_7").setValue("Yes");
            }
            if(data2.get("SP_8").toString().equals("true")){
                fields.get("B_12_8").setValue("Yes");
            }
            if(data2.get("SP_9").toString().equals("true")){
                fields.get("B_12_9").setValue("Yes");
            }
            if(data2.get("SP_10").toString().equals("true")){
                fields.get("B_12_10").setValue("Yes");
            }
            if(data2.get("SP_11").toString().equals("true")){
                fields.get("B_12_11").setValue("Yes");
            }
            if(data2.get("SP_12").toString().equals("true")){
                fields.get("B_12_12").setValue("Yes");
            }
            if(data2.get("SP_13").toString().equals("true")){
                fields.get("B_12_13").setValue("Yes");
            }
            if(data2.get("SP_14").toString().equals("true")){
                fields.get("B_12_14").setValue("Yes");
            }
            if(data2.get("SP_15").toString().equals("true")){
                fields.get("B_12_15").setValue("Yes");
            }
            if(data2.get("SP_16").toString().equals("true")){
                fields.get("B_12_16").setValue("Yes");
            }
            if(data2.get("SP_17").toString().equals("true")){
                fields.get("B_12_17").setValue("Yes");
            }
            fields.get("count_B").setValue(data2.get("SP_CircumstancesC").toString()).setFontSize(12).setBorderWidth(0f);
